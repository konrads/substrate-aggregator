...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	fn add_price_pair_new() -> Weight {
		(114_000_000 as Weight)			.saturating_add(T::DbWeight::get().reads(1 as Weight))			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn add_price_pair_existing() -> Weight {
...
impl WeightInfo for () {
	fn add_price_pair_new() -> Weight {
		(114_000_000 as Weight)			.saturating_add(RocksDbWeight::get().reads(1 as Weight))			.saturating_add(RocksDbWeight::get().writes(1 as Weight))
	}
	fn add_price_pair_existing() -> Weight {
